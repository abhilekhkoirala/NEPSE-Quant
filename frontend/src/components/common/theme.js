// ============================================================
// Design tokens — professional financial analytics theme.
//
// Personality: charcoal / restrained / analytical. One accent color
// (blue) carries all interactive/selection meaning; green/red/amber
// are reserved for gain/loss/warning semantics only. Monospace is
// used for financial figures (prices, percentages, signal scores);
// everything else — nav, headings, labels, body copy — is Inter.
// ============================================================
...
export { K, SP, RADIUS, FALLBACK_SEC_NAMES, SEC_COLOR_PALETTE, buildSecColors, TTP, REGIME_COLORS, REGIME_LABELS, ROW };
